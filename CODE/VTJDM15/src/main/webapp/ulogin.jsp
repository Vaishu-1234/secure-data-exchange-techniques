...
<body class="scan">
  ...
  <header>
    <div class="nav">
      ...
      <button class="pill" onclick="location.href='UserSignUp.jsp'"><i class="fa-regular fa-address-card"></i> Register</button>
    </div>
  </header>
  ...
  <main class="wrap">
    ...
    <section class="login-shell">
      <div class="card">
        <h2><i class="fa-solid fa-id-card-clip"></i> User Login</h2>
        <form action="UserLogin" method="post">
          <div class="input-group"><input type="text" name="email" placeholder="Enter Email" required></div>
